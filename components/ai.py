...
class HostileEnemy(BaseAI):
   ...
   def perform(self) -> None:
    ...
    # что делает функция perform:
    # если объект не в поле зрения игрока, просто ждет
    # если игрок рядом с объектом (расстояние <= 1), атакует
    # если объект в поле зрения игрока,
    # но слишком далеко, чтобы атаковать, бежит за игроком
